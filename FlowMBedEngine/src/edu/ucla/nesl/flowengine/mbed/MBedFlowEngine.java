...
public class MBedFlowEngine extends Service implements Runnable {

	private static final String TAG = MBedFlowEngine.class.getSimpleName();
	...
	private ServiceConnection mServiceConnection = new ServiceConnection() {
		@Override public void onServiceConnected(ComponentName name, IBinder service) { 
			...
			try {
				mAPI.addAbstractDevice(mMBedDeviceInterface);
	...
	private AbstractDeviceInterface.Stub mMBedDeviceInterface = new AbstractDeviceInterface.Stub() {
		@Override
